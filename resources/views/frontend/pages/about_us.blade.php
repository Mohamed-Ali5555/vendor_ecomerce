            ...
            <div class="row align-items-center">
                    ...
                    <div class="about_us_content pb-5 pb-lg-0">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <img src="{{asset($abouts->image)}}" alt="nnnnnnnnnnn">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about_us_content pl-0 pl-lg-5">
                        ...
                        <p>{!! html_entity_decode($abouts->content)!!}</p>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.2s">
                        <h2><span class="counter">{{$abouts->experience}}</span>+</h2>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.4s">
                        <h2><span class="counter">{{$abouts->happy_customer}}</span>+</h2>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.6s">
                        <h2><span class="counter">{{$abouts->team_advisor}}</span>+</h2>
                        <h5>Team Advisor</h5>
                    </div>
                </div>
                <!-- Single Cool Facts -->
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="cool_fact_text text-center wow fadeInUp" data-wow-delay="0.8s">
                        <h2><span class="counter">{{$abouts->return_customer}} </span>%</h2>
