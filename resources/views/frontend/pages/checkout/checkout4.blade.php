                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Shipping</td>
                                        <td>$ {{\Illuminate\Support\Facades\Session::get('checkout')[0]['delivery_charge']}}</td>
                                    </tr> 
                                    ...
                                    <tr>
                                        <td>Total</td>
                                           ...
                                           \Illuminate\Support\Facades\Session::get('checkout')[0]['delivery_charge']-\Illuminate\Support\Facades\Session::get('coupon')['value']),2}}</td>
                                    ...
                                    <td>$ {{number_format((float)str_replace(',','',\Gloudemans\Shoppingcart\Facades\Cart::subtotal())+\Illuminate\Support\Facades\Session::get('checkout')[0]['delivery_charge'])}}</td>
