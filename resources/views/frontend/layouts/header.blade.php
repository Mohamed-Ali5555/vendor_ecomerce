     ...
     <div class="container">
         <div class="classy-nav-container breakpoint-off">
             <nav class="classy-navbar" id="bigshopNav">
                 ...
                 <!-- Nav Brand -->
                 <a href="{{ route('home') }}" class="nav-brand"><img src="{{asset(get_setting('logo'))}}"
                         alt="logo"></a>
                 ...
                 <div class="hero_meta_area ml-auto d-flex align-items-center justify-content-end">
                     ...
                     <div class="wishlist-area">
                         ...
                         <!-- compare -->
                     <div class="cart-area">
                         <div class="cart--btn"><a href="{{route('compare')}}"> <i class="icofont-exchange"></i></a> <span
                                 class="cart_quantity" id="compare_counter">{{ \Gloudemans\Shoppingcart\Facades\Cart::instance('compare')->count() }}</span>
                         </div>
